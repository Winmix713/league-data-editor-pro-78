      ...
      <div className="flex gap-3">
        ...
        <div>
          ...
          <ul className="space-y-1 text-xs text-gray-400 list-disc pl-4">
            <li>
              <strong>date</strong>: Use YYYY-MM-DD format or HH:MM for times
            </li>
            <li>
              <strong>home_team, away_team</strong>: Team names
            </li>
            <li>
              <strong>home_score, away_score</strong>: Final scores
            </li>
            <li>
              <strong>ht_home_score, ht_away_score</strong>: Half-time scores (optional)
            </li>
            <li>
